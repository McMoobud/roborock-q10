...
Q10_SENSOR_DESCRIPTIONS = [
    ...
    RoborockSensorDescriptionQ10(
        key="q10_cleaning_area",
        value_fn=lambda data: data.clean_area,
        native_unit_of_measurement=UnitOfArea.SQUARE_METERS,
        translation_key="cleaning_area",
    ),
    RoborockSensorDescriptionQ10(
        key="q10_total_clean_area",
    ...
    RoborockSensorDescriptionQ10(
        key="q10_total_clean_count",
        value_fn=lambda data: data.total_clean_count,
        state_class=SensorStateClass.TOTAL_INCREASING,
        translation_key="total_cleaning_count",
    ),
    RoborockSensorDescriptionQ10(
        key="q10_total_clean_time",
...
class RoborockSensorEntityQ10(RoborockCoordinatedEntityB01Q10, SensorEntity):
    """Representation of a Q10 Roborock sensor."""
